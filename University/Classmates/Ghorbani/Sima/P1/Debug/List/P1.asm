...
; 0000 001B        delay_ms(1000);
	RCALL SUBOPT_0x0
; 0000 001C        PORTA=num[6];
	__POINTW1FN _num,6
	RCALL SUBOPT_0x1
; 0000 001D        delay_ms(1000);
; 0000 001E        PORTA=num[5];
	__POINTW1FN _num,5
	RCALL SUBOPT_0x1
; 0000 001F        delay_ms(1000);
; 0000 0020        PORTA=num[4];
	__POINTW1FN _num,4
	RCALL SUBOPT_0x1
; 0000 0021        delay_ms(1000);
; 0000 0022        PORTA=num[3];
	__POINTW1FN _num,3
	RCALL SUBOPT_0x1
; 0000 0023        delay_ms(1000);
; 0000 0024        PORTA=num[2];
	__POINTW1FN _num,2
	RCALL SUBOPT_0x1
; 0000 0025        delay_ms(1000);
; 0000 0026        PORTA=num[1];
	__POINTW1FN _num,1
	RCALL SUBOPT_0x1
; 0000 0027        delay_ms(1000);
; 0000 0028        PORTA=num[0];
	LDI  R30,LOW(_num*2)
	LDI  R31,HIGH(_num*2)
	RCALL SUBOPT_0x1
...
; 0000 002D        PORTB.6=1;
	RCALL SUBOPT_0x2
; 0000 002E        delay_ms(2000);
; 0000 002F     //green
; 0000 0030        PORTB.6=0;
; 0000 0031        PORTB.7=1;
	SBI  0x18,7
; 0000 0032        PORTA=num[5];
	__POINTW1FN _num,5
	RCALL SUBOPT_0x1
; 0000 0033        delay_ms(1000);
; 0000 0034        PORTA=num[4];
	__POINTW1FN _num,4
	RCALL SUBOPT_0x1
; 0000 0035        delay_ms(1000);
; 0000 0036        PORTA=num[3];
	__POINTW1FN _num,3
	RCALL SUBOPT_0x1
; 0000 0037        delay_ms(1000);
; 0000 0038        PORTA=num[2];
	__POINTW1FN _num,2
	RCALL SUBOPT_0x1
; 0000 0039        delay_ms(1000);
; 0000 003A        PORTA=num[1];
	__POINTW1FN _num,1
	RCALL SUBOPT_0x1
; 0000 003B        delay_ms(1000);
; 0000 003C        PORTA=num[0];
	LDI  R30,LOW(_num*2)
	LDI  R31,HIGH(_num*2)
	RCALL SUBOPT_0x1
